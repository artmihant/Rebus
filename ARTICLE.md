# Решаем арифметические ребусы с помощью алгебры и python
...
Легко видеть, что в худшем случае нам придется перебрать 10! = 3628800 подстановок. Не так уж много - однако, тест `ТРАВА+КОРОВА+ДОЯРКА = МОЛОКО`, содержащий как раз 10 букв, исполняется на моей машине 18 секунд.

<картинка изумленная корова>
...
Посмотреть алгоритм в действии вы можете на сайте: https://artmihant.github.io/rebus/

Полный код опубликован на github: https://github.com/artmihant/rebus . Помимо всего вышеперечисленного там можно две вещи, которые я решил не включать в статью: распараллеливание на python и рабочую реализацию яндекс.функции, исполняющей роль сервера для онлайн-демки.
